...
pub struct HandoffQuery {
    ...
    /// [`ai_memory_store::brief::BRIEF_BUDGET_MIN`],
    /// [`ai_memory_store::brief::BRIEF_BUDGET_MAX`]; defaults to
    /// [`ai_memory_store::brief::BRIEF_BUDGET_DEFAULT`] when absent or
    /// unparsable.
